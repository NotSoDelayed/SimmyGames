...
//     */
//    public GameKit item(@Nullable Material material) {
...
//     * @return the kit, for chaining
//     */
//    public GameKit items(List<Material> materials) {
//        for (Material material : materials) {
//            for (int index = 0; index < Byte.MAX_VALUE; index++) {
//                if (items().get(index) != null)
//                    continue;
...
//     * @return the kit, for chaining
//     */
//    public GameKit item(@Nullable ItemStack item) {
//        for (int index = 0; index < Byte.MAX_VALUE; index++) {
//            if (items().get(index) != null)
//                continue;
//            setItem(index, item);
...
//     * @return the kit, for chaining
//     */
//    public GameKit itemstacks(List<ItemStack> items) {
