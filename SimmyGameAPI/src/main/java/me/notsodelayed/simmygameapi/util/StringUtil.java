...
public class StringUtil {
    ...
    public static final String CROSSED_MARK = "✖";
    public static final String INFORMATION_MARK = "ⓘ";
    ...
    public static String getDamageEventSummary(EntityDamageEvent event) {
        ...
        return switch (event.getCause()) {
            ...
            case FIRE, FIRE_TICK, HOT_FLOOR, LAVA -> "Burnt!!";
            ...
            case VOID, WORLD_BORDER -> "Goodbye cruel world...";
            // CUSTOM, KILL, SUICIDE
            default -> "Died!";
        };
    }
